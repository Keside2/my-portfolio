...
export default function ContactPage() {
  ...
  const handleWhatsApp = () => {
    window.open(
      `https://wa.me/2349022807412?text=Hi Godwin, I'm reaching out about...`,
      "_blank",
    );
  };
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20 md:pt-32 pb-16">
        <AnimatedSection animation="fade-up" className="mb-12 text-center">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto text-lg italic">
            "I'm currently available for full-time roles, contract work, and
          ...
          <div className="space-y-6">
              ...
              <Card className="bg-zinc-900 shadow-xl border-zinc-800 p-6 sm:p-8 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 group hover:border-cyan-500/30 transition-all">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-cyan-400 hover:text-cyan-300 font-bold underline break-all"
                  >
                    {personalInfo.email}
                  </a>
                </div>
            ...
            <AnimatedSection animation="slide-right" delay={100}>
              <Card className="bg-zinc-900 shadow-xl border-zinc-800 p-6 sm:p-8 flex flex-col sm:flex-row items-start gap-4 sm:gap-6 group hover:border-green-500/30 transition-all">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-1 text-green-400">
                    WhatsApp Live Chat
                  </h3>
                  <p className="text-zinc-400 text-sm mb-4">
                    Fastest response for urgent projects.
                  </p>
                  <Button
                    onClick={handleWhatsApp}
                    className="bg-green-500 hover:bg-green-600 font-bold text-black h-12 uppercase tracking-wide w-full sm:w-auto"
                  >
                    Start Chat Now
                  </Button>
                </div>
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="text-xs uppercase text-zinc-500 font-bold px-1">
                      Full Name
                    </label>
                    <input
                      type="text"
                ...
                <Button
                  type="submit"
                  className="w-full bg-cyan-500 hover:bg-cyan-600 font-bold text-black h-12 uppercase tracking-widest text-sm"
                  disabled={loading}
                >
                  {loading ? (
