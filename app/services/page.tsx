...
export default function ServicesPage() {
  const handleBookConsultation = () => {
    window.open("https://wa.me/2349022807412", "_blank");
  };
      ...
      <div className="relative z-10 container mx-auto px-4 pt-24 pb-16">
        <AnimatedSection animation="fade-up" className="mb-12 text-center">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto text-lg italic">
            "I don’t just build apps—I solve business problems through
            technology."
          </p>
        </AnimatedSection>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card className="bg-zinc-900/60 border-zinc-800 p-6 text-center">
              ...
              <p className="text-sm text-zinc-400 mb-6">
                Let's discuss how we can scale your product together.
              </p>
              <Button
                onClick={handleBookConsultation}
                className="w-full bg-cyan-500 hover:bg-cyan-600 font-bold text-black h-12"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pb-16">
          {[
            {
              title: "Velocity",
              desc: "Fast-paced delivery without compromising on quality.",
              icon: Zap,
            },
            {
              title: "Scalability",
              desc: "Architected to handle massive growth from day one.",
              icon: Rocket,
            },
            {
              title: "Security",
              desc: "Best-in-class security patterns and data protection.",
              icon: ShieldCheck,
            },
            {
              title: "UX-Focused",
              desc: "Obsessed with creating intuitive user experiences.",
              icon: Users,
            },
          ].map((item, index) => (
            <AnimatedSection
